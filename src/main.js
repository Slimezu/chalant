import * as Cesium from 'https://cdn.jsdelivr.net/npm/cesium@1.120/Build/Cesium/Cesium.js';
...
import { LocalModelController } from './voice/LocalModelController.js';
...
async function init() {
  ...
  try {
	...
	window.__gevVoiceCommands = new LocalModelController({
		viewer,
		styleManager,
		dataManager,
		sceneDirector,
